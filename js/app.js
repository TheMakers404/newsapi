$(document).ready(function () {
  ...
  let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=b7f1b9bd6c28474687a47922ae4f889d";
        ...
        output += `
          ...
          <div class="card medium hoverable">
            ...
            if(previousArticleUrl{
              var linkedarticle = <a href ="${ previousArticleUrl}">
              ${output}
              </a>
            ;
            }
            else{
              var  linkedarticle = output;
            }
            output += linkedarticle;
            previousArticleUrl = latestNews[i].url;
          }
